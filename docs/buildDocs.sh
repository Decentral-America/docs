...
python3 -m pip install --upgrade --force-reinstall pip wheel setuptools virtualenv gitpython py-rsync sphinx sphinx-rtd-theme sphinx-copybutton rinohtype pygments docutils recommonmark 
...
export OUTPUT_FILE="documentation"
...
<html>
   <head>
      <title>Decentral America Docs</title>
