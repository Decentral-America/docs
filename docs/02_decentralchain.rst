...
* Each :ref:`transaction <02_decentralchain:Transaction>` is created on behalf of a certain account. 
* All the :ref:`tokens <02_decentralchain:Token (Asset)>` belong to certain accounts.
* All the data is associated with accounts. For details, see the :ref:`account data storage <02_decentralchain:Account Data Storage>` article.
...
DecentralChain uses an asymmetric cryptographic system based on the elliptic curve Curve25519-ED25519 with X25519 keys. The guideline for generating keys and signatures is given in the :ref:`cryptographic practical details <02_decentralchain:Cryptographic Practical Details>` article.
...
* If you lose your secret phrase or private key, you will no longer be able to access your account ever again. We strongly encourage you to :ref:`backup of your secret phrase <02_decentralchain:Backup Seed Phrase>`.
...
For ways to generate account keys, see the :ref:`creating an account <02_decentralchain:Creating an Account>` article.

Creating an Account
===================

To create an account means to generate an :ref:`account key pair <02_decentralchain:Account Keys>` and :ref:`address <02_decentralchain:Address>` based on a :ref:`secret (seed) phrase <02_decentralchain:Secret (Seed) Phrase>`.
...
* At this point you will be forwarded to your wallet page. You must do a :ref:`backup of your seed phrase <02_decentralchain:Backup Seed Phrase>`.
...
Address is an :ref:`account <02_decentralchain:Account>` attribute derived from the :ref:`public key <02_decentralchain:Account Keys>`. The address also contains the :ref:`chain ID <02_decentralchain:Chain ID>` that identifies the blockchain network, therefore the address on the Mainnet cannot be used on the Testnet and vice versa.

The address is a :math:`26` byte array (see the :ref:`address binary format <02_decentralchain:Address Binary Format>`). In UIs the address is displayed as a base58 encoded string.
...
* :ref:`Token balances <02_decentralchain:Account Balance>`,
* Entries of :ref:`account data storage <02_decentralchain:Account Data Storage>`,
* :ref:`Aliases <02_decentralchain:Alias>`,
* :ref:`Assigned script <02_decentralchain:dApp and Smart Account>`, etc.

The address is indicated:

* In :ref:`transfer <02_decentralchain:Transfer Transaction>`, :ref:`mass transfer <02_decentralchain:Mass Transfer Transaction>` and :ref:`lease transaction  <02_decentralchain:Lease Transaction>` to identify a recipient;
* In :ref:`invoke script transactions <02_decentralchain:Invoke Script Transaction>` to identify an invoked dApp.
...
Alias is a short, easy to remember, name of the :ref:`address <02_decentralchain:Address>`. The alias is unique on the blockchain. One address can have several aliases. The alias can be used instead of the address:

* In :ref:`transfer <02_decentralchain:Transfer Transaction>`, :ref:`mass transfer <02_decentralchain:Mass Transfer Transaction>` and :ref:`lease transaction <02_decentralchain:Lease Transaction>` to identify a recipient; as well as in :ref:`invoke script transactions <02_decentralchain:Invoke Script Transaction>` to identify an invoked dApp.
...
The list of account aliases, as well as other blockchain data, is public and can be read by anyone. For example, you can see aliases in `DecentralChain Explorer <https://decentralscan.com/>`_. To do this, find an account by its :ref:`address <02_decentralchain:Address>` and switch to the Aliases tab.
...
See the :ref:`alias binary format <02_decentralchain:Alias Binary Format>` article.

Account Balance
===============

Account balance is the amount of a :ref:`token (asset) <02_decentralchain:Token (Asset)>` that belongs to the :ref:`account <02_decentralchain:Account>`.
...
The regular balance is the amount of :ref:`DecentralCoins <02_decentralchain:DecentralCoin>` that belongs directly to the account. Thе other types of balances are determined counting :ref:`leased <02_decentralchain:Leased Proof of Stake>` DecentralCoins.
...
The generating balance of a :ref:`node <02_decentralchain:Node>` account affects the ability to participate in block generation. To generate blocks, you need a generating balance of at least :math:`10000` DecentralCoins. The larger the generating balance, the greater the chance to add the next block is.
...
For example, you can see the list of tokens and their amount on the account in `DecentralChain Explorer <https://decentralscan.com/>`_. To do this, find an account by its address or alias. Balances in :ref:`DecentralCoin <02_decentralchain:DecentralCoin>` are displayed right under the address, balances in other assets are at the Assets tab, and :ref:`non-fungible tokens (NFT) <02_decentralchain:Non-Fungible Token>` are at the Non-fungible tokens tab.
...
Account data storage is a key-value storage associated with an :ref:`account <02_decentralchain:Account>`. 
...
The size of an account data storage is unlimited. For key and value size limitations, see the :ref:`data transaction <02_decentralchain:Data Transaction>` article.

View Account Data
-----------------

Data storage of any account, as well as other blockchain data, are public and can be read by anyone. For example, you can see data entries in `DecentralChain Explorer <https://decentralscan.com/>`_. To do this, find an account by its :ref:`address <02_decentralchain:Address>` or :ref:`alias <02_decentralchain:Alias>` and switch to the Data tab.
...
The account owner can add, modify or delete entries of the account data storage via a :ref:`data transaction <02_decentralchain:Data Transaction>`. 

A :ref:`dApp script <02_decentralchain:dApp and Smart Account>` can add, modify or delete entries in the dApp's data storage as a result of an :ref:`invoke script <02_decentralchain:Invoke Script Transaction>` transaction via script actions:

* :ref:`BinaryEntry <03_ride-language:BinaryEntry>`
* :ref:`BooleanEntry <03_ride-language:BooleanEntry>`
* :ref:`IntegerEntry <03_ride-language:IntegerEntry>`
* :ref:`StringEntry <03_ride-language:StringEntry>`
* :ref:`DeleteEntry <03_ride-language:DeleteEntry>`

dApp and Smart Account
======================

An account with a script assigned to it becomes a dApp or smart account.
dApp is the account with the :ref:`dApp script <03_ride-language:dApp Script>` assigned. dApp is an application whose functions can be called from other accounts via an :ref:`invoke script transaction <02_decentralchain:Invoke Script Transaction>`. Callable functions can accept payments to the dApp and also perform actions applied to the blockchain:
...
A smart account is an account with the :ref:`account script <03_ride-language:Account Script>` assigned. The account script is similar to a verifier function of a dApp script. Please note:

* To assign a script to an account, you have to send a :ref:`set script transaction <02_decentralchain:Set Script Transaction>` on behalf of the account.
* You can also change or delete the script via the set script transaction, unless the script itself prohibits it.
* The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for any transaction sent from a dApp or smart account is increased by :math:`0.004` DecentralCoins if the complexity of sender's account script or dApp script verifier function exceeds the :ref:`sender complexity threshold <03_ride-language:Limitations>`. 
...
DecentralCoin is the native token on the DecentralChain blockchain. :ref:`More about DecentralCoin <02_decentralchain:DecentralCoin>`.
...
* For trading on `Decentral.Exchange <https://decentral.exchange/>`_ (except for :ref:`NFTs <02_decentralchain:Non-Fungible Token>`; :ref:`smart assets <02_decentralchain:Smart Asset>` trading is temporarily unavailable),
* For payments attached to dApp :ref:`script invocation <02_decentralchain:Invoke Script Transaction>`.
...
* On the next screen specify the token parameters:
  ...
  * :ref:`Smart asset <02_decentralchain:Smart Asset>`: A smart asset is an asset with an attached script that places conditions on every transaction made for the asset in question.
...
The transaction fee is :math:`1` DecentralCoin for a regular token or :math:`0.001` DecentralCoins for a :ref:`non-fungible token (NFT) <02_decentralchain:Non-Fungible Token>`.
Moreover, the token can be issued by the :ref:`dApp script <03_ride-language:dApp Script>` as a result of the :ref:`invoke script transaction <02_decentralchain:Invoke Script Transaction>` when the callable function result contains the :ref:`issue action <03_ride-language:Issue>`. The minimum fee for invoke script transaction is increased by :math:`1` DecentralCoin for each non-NFT token issued.
...
* If the token is issued by :ref:`issue transaction <02_decentralchain:Issue Transaction>`, the token ID is the same as the transaction ID.
* If the token is issued by :ref:`invoke script transaction <02_decentralchain:Invoke Script Transaction>` when the callable function of :ref:`dApp script <02_decentralchain:dApp and Smart Account>` performed the :ref:`issue action <03_ride-language:Issue>`, the token ID is calculated as the BLAKE2b-256 hash of the byte array containing transaction ID and the fields of the Issue structure.
...
The :ref:`DecentralCoin <02_decentralchain:DecentralCoin>` token has no identifier. The Node REST API uses null for DecentralCoin.
...
Can be done via a :ref:`transfer transaction <02_decentralchain:Transfer Transaction>` or a :ref:`mass transfer transaction <02_decentralchain:Mass Transfer Transaction>`.
A :ref:`dApp script <02_decentralchain:dApp and Smart Account>` can transfer the token via a :ref:`script transfer script action <03_ride-language:Issue>` as a result of an :ref:`invoke script transaction <02_decentralchain:Invoke Script Transaction>`.

* Exchange (trade deal)

Three accounts can participate in the exchange: one user creates an :ref:`order <02_decentralchain:Order>` to buy a token, the other creates an order to sell a token. The matcher combines buy and sell orders with suitable parameters and creates an :ref:`exchange transaction <02_decentralchain:Exchange Transaction>`.

* Burning

Decreases the amount of token on the account and thereby the total amount of the token on the blockchain. Any token owner can burn it, not only the issuer. It is impossible to burn :ref:`DecentralCoin <02_decentralchain:DecentralCoin>`. Can be done via a :ref:`burn transaction <02_decentralchain:Burn Transaction>`.
A dApp script can burn the token via a :ref:`burn script action <03_ride-language:Burn>` as a result of the Invoke script transaction.

* Payment to :ref:`dApp <02_decentralchain:dApp and Smart Account>`

An :ref:`invoke script transaction <02_decentralchain:Invoke Script Transaction>` can contain up to two payments to the dApp. Payment amount and token are available to the callable function.
...
The token issuer can enable sponsorship which allows all users to pay fees in this token (instead of DecentralCoins) for invoke script transactions and transfer transactions. :ref:`More about sponsorship <02_decentralchain:Sponsored Fees>`. Enabling or disabling sponsorship can be done via a :ref:`sponsor fee transaction<02_decentralchain:Sponsor Fee Transaction>`. A dApp script can set up sponsorship using a :ref:`SponsorFee <03_ride-language:SponsorFee>` as a result of the invoke script transaction.

* Reissue

Increases the amount of token on the blockchain. The reissuable field of token determines whether the token can be reissued. Can be done via a :ref:`reissue transaction <02_decentralchain:Reissue Transaction>`.
A dApp script can reissue the token via a :ref:`reissue script action <03_ride-language:Reissue>` as a result of the invoke script transaction.

* Replacing the asset script

Can be done via a :ref:`set asset script transaction <02_decentralchain:Set Asset Script Transaction>`. If the token is not a smart asset, that is, the script was not attached when the token was issued, then it is impossible to attach the script later.

* Modifying the token name and / or description

Can be done via an :ref:`update asset info transaction <02_decentralchain:Update Asset Info Transaction>`.
...
Non-fungible token or NFT is a special type of a :ref:`token <02_decentralchain:Token (Asset)>` that is issued with the following parameters:
...
NFT can be issued in the same ways as a regular token, see :ref:`token issue <02_decentralchain:Token Issue>`. The minimum fee for an NFT issue is :math:`0.001` DecentralCoins, :math:`1000` times less than for a regular token.

Smart Asset
-----------

Smart asset is a :ref:`token <02_decentralchain:Token (Asset)>` that has an :ref:`asset script <03_ride-language:Asset Script>` assigned to it.
By default, tokens on the DecentralChain blockchain are not smart contracts, and any transactions with them are allowed. The script endows a token with functionality that sets the rules for its circulation. Each transaction involving a smart asset is automatically checked against the conditions specified in the script. If the asset's script allows the transaction, it will be executed; if the script denies the transaction, it is either not put onto the blockchain at all or saved as failed (for details, see the :ref:`transaction validation <02_decentralchain:Transaction Validation>` article).
...
* The asset script can be changed using the :ref:`set asset script transaction <02_decentralchain:Set Asset Script Transaction>`, unless prohibited by the asset script itself (as well as by the :ref:`dApp or account script <02_decentralchain:dApp and Smart Account>` assigned to the issuer account).
* The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for transaction is increased by :math:`0.004` DecentralCoins for each smart asset involved, except for:

  * :ref:`Invoke script transactions <02_decentralchain:Invoke Script Transaction>`,
  * Smart assets used as matcher fee in :ref:`exchange transaction <02_decentralchain:Exchange Transaction>`.
...
DecentralCoin is the native :ref:`token <02_decentralchain:Token (Asset)>` of the DecentralChain blockchain. :ref:`Block generators <02_decentralchain:Generating Node>` receive :ref:`transaction fees <02_decentralchain:Transaction Fees>` and :ref:`block rewards <02_decentralchain:Block Reward>` in DecentralCoins, which encourages generators to maintain and develop the blockchain network infrastructure. The more DecentralCoins the generator holds (by ownership or lease), the greater its chance to add the next block is.
...
The owner of DecentralCoins can lease them via a :ref:`lease transaction <02_decentralchain:Lease Transaction>`. DecentralCoins received on lease are included in the :ref:`generating balance <02_decentralchain:Account Balance>`. Block generators send back different percentages as rewards to lessors. A lessor can cancel the lease at any time via a :ref:`lease cancel transaction <02_decentralchain:Lease Cancel Transaction>`. :ref:`More about leasing <02_decentralchain:Leased Proof of Stake>`.
...
Each transaction contains the public key of the sender’s account, on behalf of which the action is performed on the blockchain. :ref:`Smart accounts and dApps <02_decentralchain:dApp and Smart Account>` can set their own rules for outgoing transactions verification. 
...
Transaction fee is a fee that an :ref:`account <02_decentralchain:Account>` owner pays to send a :ref:`transaction <02_decentralchain:Transaction>`. A transaction sender can specify any amount of fee but not less than the minimum amount. The larger the fee is, the quicker the transaction will be added to the new :ref:`block <02_decentralchain:Block>`.
For :ref:`invoke script transactions <02_decentralchain:Invoke Script Transaction>` and :ref:`transfer transaction <02_decentralchain:Transfer Transaction>`, a sender can specify a transaction fee nominated in a sponsored asset instead of :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`, see the section :ref:`fee in sponsored asset <02_decentralchain:Fee in Sponsored Asset>` below.
...
* If the transaction sender is a :ref:`dApp or smart account <02_decentralchain:dApp and Smart Account>`, and the complexity of the account script or dApp script verifier function exceeds the :ref:`sender complexity threshold <03_ride-language:Limitations>`, the minimum fee is increased by :math:`0.004` DecentralCoins. If the order sender in :ref:`exchange transaction <02_decentralchain:Exchange Transaction>` is a dApp or smart account, this does nor affect the minimum fee.
* The minimum fee is increased by :math:`0.004` DecentralCoins for each smart asset involved, except for:

  * :ref:`Invoke script transactions <02_decentralchain:Invoke Script Transaction>`,
  * :ref:`Smart assets <02_decentralchain:Smart Asset>` used as matcher fees in exchange transactions.
...
If the account script complexity is higher than the :ref:`sender complexity threshold <03_ride-language:Limitations>`.
...
* dApp script invocation issues an asset that is not :ref:`non-fungible tokens <02_decentralchain:Non-Fungible Token>`: :math:`0.005 + 1 = 1.005` DecentralCoins.
...
:ref:`Invoke script transactions <02_decentralchain:Invoke Script Transaction>` and :ref:`exchange transactions <02_decentralchain:Exchange Transaction>` can be saved on the blockchain even if the result of a dApp script or asset script execution failed. In this case, the sender is charged a fee. For an exchange transaction, the matcher is charged the transaction fee but the order senders are not charged the matcher fee. :ref:`More about transaction validation<02_decentralchain:Transaction Validation>`.

Fee in Sponsored Asset
^^^^^^^^^^^^^^^^^^^^^^

An issuer of an asset can set up sponsorship — so that any user can specify a transaction fee in this asset for :ref:`invoke script transactions <02_decentralchain:Invoke Script Transaction>` and :ref:`transfer transactions <02_decentralchain:Transfer Transaction>`.
To activate sponsorship, the issuer puts a :ref:`sponsor fee transaction<02_decentralchain:Sponsor Fee Transaction>` that specifies an amount of asset that is equivalent to the minimum fee of :math:`0.001` DecentralCoins. For example, if minSponsoredAssetFee: :math:`5`, then the fee in this asset for an invoke script transaction equals :math:`5 * \frac{0.005}{0.001} = 25`. 
...
An account that issued an asset can enable sponsorship, that is, allow all users to pay a fee in this asset for :ref:`invoke script transactions <02_decentralchain:Invoke Script Transaction>` and :ref:`transfer transactions <02_decentralchain:Transfer Transaction>`. The sponsor can distribute the sponsored asset among app users.
...
* The fee in the sponsored asset can only be specified for :ref:`invoke script transactions <02_decentralchain:Invoke Script Transaction>` and :ref:`transfer transactions <02_decentralchain:Transfer Transaction>`.

How It Works
^^^^^^^^^^^^

After :ref:`enabling sponsorship <02_decentralchain:How to Enable Sponsorship>`, if the requirements described in the :ref:`restrictions <02_decentralchain:Restrictions>` section are met, the sponsorship works as follows:
...
* Block generators receive the fee in DecentralCoins from the sponsor's account (in accordance with the :ref:`DecentralChain-M5 protocol <02_decentralchain:DecentralChain-M5 Protocol>`, the fee is distributed between the current block generator and the next block generator in a ratio of :math:`\frac{40}{60}`.
...
The fee in :ref:`DecentralCoins <02_decentralchain:DecentralCoin>` charged to the sponsor is proportional to the fee specified by the transaction sender:
...
For example, if the sponsor sets :math:`3` tokens = :math:`0.001` DecentralCoins, then the minimum fee for :ref:`invoke script transactions <02_decentralchain:Invoke Script Transaction>` is :math:`15` tokens, which corresponds to :math:`0.005` DecentralCoins. Please note:
...
The fields that depend on the type of transaction are listed in the description of each :ref:`type of transaction <02_decentralchain:Transaction Types>`.
...
The transaction signature and ID are also formed on the basis of the binary format. The guideline for generating a signature and ID is given in the :ref:`cryptographic practical details <02_decentralchain:Cryptographic Practical Details>` article.
Transaction binary format is described in the :ref:`transaction binary format <02_decentralchain:Transaction Binary Format>` article.
...
Issue transaction creates a new :ref:`token <02_decentralchain:Token (Asset)>`.

:strong:`Fee`

The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for an issue transaction is :math:`1` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`, in case of issue of a :ref:`non-fungible tokens (NFT) <02_decentralchain:Non-Fungible Token>` :math:`0.001` DecentralCoins.

If the transaction sender is a :ref:`dApp or smart account <02_decentralchain:dApp and Smart Account>`, and the complexity of the account script or dApp script verifier function exceeds the :ref:`sender complexity threshold <03_ride-language:Limitations>`, the minimum fee is increased by :math:`0.004` DecentralCoins. 
...
The assetId field does not need to be filled when sending a transaction, and it is not stored on the blockchain. The node calculates these fields when providing transaction data via the REST API. The fields that are common to all types of transactions are described in the :ref:`transaction <02_decentralchain:Transaction>` article.

:strong:`Binary Format`

See the :ref:`issue transaction binary format <02_decentralchain:Issue Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`IssueTransaction structure <03_ride-language:IssueTransaction>` is used for transaction handling in smart contracts.

Reissue Transaction
^^^^^^^^^^^^^^^^^^^

Reissue transaction increases the amount of the :ref:`token <02_decentralchain:Token (Asset)>` on the blockchain and/or prohibits its reissue. Only the token issuer can send a reissue transaction. The additional amount of token increases the balance of the transaction sender. The reissuable field of the token determines whether the token can be reissued.

:strong:`Fee`

The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for a reissue transaction is :math:`0.001` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`. If the token is a smart asset, the minimum fee is increased by :math:`0.004` DecentralCoins.
...
The fields that are common to all types of transactions are described in the :ref:`transaction <02_decentralchain:Transaction>` article.

:strong:`Binary Format`

See the :ref:`reissue transaction binary format <02_decentralchain:Reissue Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`ReissueTransaction structure <03_ride-language:ReissueTransaction>` is used for transaction handling in smart contracts.
...
The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for a burn transaction is :math:`0.001` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`, in case of burning a smart asset :math:`0.005` DecentralCoins.
...
See the :ref:`burn transaction binary format <02_decentralchain:Burn Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`BurnTransaction structure <03_ride-language:BurnTransaction>` is used for transaction handling in smart contracts.

Set Asset Script Transaction
^^^^^^^^^^^^^^^^^^^^^^^^^^^^

Set asset script transaction replaces the :ref:`asset script <03_ride-language:Asset Script>`. Only the token issuer can send an asset script transaction. If a token is issued without a script, then no script can be assigned to it. It is also impossible to remove the script and turn the smart asset into a regular one.

:strong:`Fee`

The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for a set asset script transaction is :math:`1` :ref:`DecentralCoin <02_decentralchain:DecentralCoin>`. 
...
See the :ref:`set asset script transaction binary format <02_decentralchain:Set Asset Script Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`SetAssetScriptTransaction structure <03_ride-language:SetAssetScriptTransaction>` is used for transaction handling in smart contracts.
...
The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for an update asset info transaction is :math:`0.001` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`, in case of a smart asset :math:`0.005` DecentralCoins.
...
See the :ref:`update asset info transaction binary format <02_decentralchain:Update Asset Info Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`UpdateAssetInfoTransaction structure <03_ride-language:UpdateAssetInfoTransaction>` is used for transaction handling in smart contracts.
...
The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for a transfer transaction is :math:`0.001` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`, in case of transferring a smart asset :math:`0.005` DecentralCoins.
...
See the :ref:`transfer transaction binary format <02_decentralchain:Transfer Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`TransferTransaction structure <03_ride-language:TransferTransaction>` is used for transaction handling in smart contracts.
...
The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for an exchange transaction is :math:`0.003` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`. In case of exchange of a :ref:`smart asset <02_decentralchain:Smart Asset>` for an ordinary asset the minimum fee is :math:`0.007` DecentralCoins, in case of exchange of two smart assets the minimum fee is :math:`0.011` DecentralCoins.
...
See the :ref:`exchange transaction binary format <02_decentralchain:Exchange Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`ExchangeTransaction structure <03_ride-language:ExchangeTransaction>` is used for transaction handling in smart contracts.

Create Alias Transaction
^^^^^^^^^^^^^^^^^^^^^^^^

Create Alias transaction creates an :ref:`alias <02_decentralchain:Alias>` for the sender's address.A created alias cannot be deleted.

:strong:`Fee`

The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for a Create Alias transaction is :math:`0.001` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`.
...
See the :ref:`create alias transaction binary format <02_decentralchain:Create Alias Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`CreateAliasTransaction structure <03_ride-language:CreateAliasTransaction>` is used for transaction handling in smart contracts.

Mass Transfer Transaction
^^^^^^^^^^^^^^^^^^^^^^^^^

Mass transfer transaction transfers a :ref:`token <02_decentralchain:Token (Asset)>` to several accounts, from :math:`1` :ref:`DecentralCoin <02_decentralchain:DecentralCoin>` to :math:`100` DecentralCoins .

:strong:`Fee`

The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for a Mass Transfer transaction is :math:`0.001 + 0.0005 × N` DecentralCoins, in case of transferring a :ref:`smart asset <02_decentralchain:Smart Asset>` :math:`0.001 + 0.0005 × N` DecentralCoins, where :math:`N` DecentralCoins is the number of recipients. The fee value is rounded up to three decimals.
...
See the :ref:`mass transfer transaction binary format <02_decentralchain:Mass Transfer Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`MassTransferTransaction structure <03_ride-language:MassTransferTransaction>` is used for transaction handling in smart contracts.

Data Transaction
^^^^^^^^^^^^^^^^

Data transaction adds, modifies and deletes data entries in sender's :ref:`account data storage <02_decentralchain:Account Data Storage>`. Limitations are as follows:
...
The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for a Data transaction is :math:`0.001` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>` per kilobyte, the size is rounded up to an integer number of kilobytes.
...
See the :ref:`data transaction binary format <02_decentralchain:Data Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`DataTransaction structure <03_ride-language:Limitations>` is used for transaction handling in smart contracts.

Set Script Transaction
^^^^^^^^^^^^^^^^^^^^^^

Set script transaction assigns the dApp script :ref:`dApp script <03_ride-language:dApp Script>` or :ref:`account script <03_ride-language:Account Script>` to the sender's account.

:strong:`Fee`

The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for a Set Script transaction is :math:`0.001` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`.
...
See the :ref:`set script transaction binary format <02_decentralchain:Set Script Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`SetScriptTransaction structure <03_ride-language:SetScriptTransaction>` is used for transaction handling in smart contracts.

Invoke Script Transaction
^^^^^^^^^^^^^^^^^^^^^^^^^

Invoke script transaction invokes the :ref:`callable function <03_ride-language:Callable Function>` of the :ref:`dApp <02_decentralchain:dApp and Smart Account>`. 
...
The sender can specify a transaction fee nominated in a sponsored asset instead of DecentralCoins, see the :ref:`sponsored fee <02_decentralchain:Sponsored Fees>` article.

The :ref:`minimum fee <02_decentralchain:Minimum Fee>` in :ref:`DecentralCoins <02_decentralchain:DecentralCoin>` for an invoke script transaction is Fee :math:`= 0.005 + S + 1 × I`.
...
* :math:`I` is the number of issued assets that are not :ref:`NFT <02_decentralchain:Non-Fungible Token>`.

:strong:`Total Complexity`

A dApp callable function can invoke a callable function of another dApp, or another callable function of the same dApp, or even itself. All invoked functions are executed within a single Invoke Script transaction. :ref:`More about dApp-to-dApp invocation <03_ride-language:dApp-to-App Invocation>`.

The total :ref:`complexity <03_ride-language:Script Complexity>` is limited by :math:`26,000` for all callable functions and asset scripts of involved smart assets in a single invoke script transaction. The sender's account script complexity is not included in that limit.
...
See the :ref:`invoke script transaction binary format <02_decentralchain:Invoke Script Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`InvokeScriptTransaction structure <03_ride-language:InvokeScriptTransaction>` is used for transaction handling in smart contracts.
...
Leased tokens remain locked on the sender's account with the full control of their owner. The sender can cancel the lease at any time by the :ref:`lease cancel transaction <02_decentralchain:Lease Cancel Transaction>`. 

:strong:`Fee`

The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for a lease transaction is :math:`0.001` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`.
...
See the :ref:`lease transaction binary format <02_decentralchain:Lease Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`LeaseTransaction structure <03_ride-language:LeaseTransaction>` is used for transaction handling in smart contracts.

Lease Cancel Transaction
^^^^^^^^^^^^^^^^^^^^^^^^

Lease cancel transaction cancels the leasing. See the :ref:`lease transaction <02_decentralchain:Lease Transaction>` article.

:strong:`Fee`

The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for a lease cancel transaction is :math:`0.001` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`.
...
See the :ref:`lease cancel transaction binary format <02_decentralchain:Lease Cancel Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`LeaseCancelTransaction structure <03_ride-language:LeaseCancelTransaction>` is used for transaction handling in smart contracts.

Sponsor Fee Transaction
^^^^^^^^^^^^^^^^^^^^^^^

Sponsor fee transaction enables or disables sponsorship. Sponsorship allows any user to pay a fee in the sponsored asset (instead of DecentralCoins) for invoke script transactions and transfer transactions. :ref:`More about sponsorship <02_decentralchain:Sponsored Fees>`.

Only the asset issuer can set up sponsorship. Smart asset cannot be a sponsored asset.

:strong:`Fee`

The :ref:`minimum fee <02_decentralchain:Minimum Fee>` for the sponsor fee transaction is :math:`0.001` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`.
...
See the :ref:`sponsor fee transaction binary format <02_decentralchain:Sponsor Fee Transaction Binary Format>`.

:strong:`Ride Structure`

The :ref:`SponsorFeeTransaction structure <03_ride-language:SponsorFeeTransaction>` is used for transaction handling in smart contracts.
...
Genesis transaction accrues :ref:`DecentralCoins <02_decentralchain:DecentralCoin>` to account upon the initial distribution of DecentralCoins during the creation of the blockchain. The first block of the blockchain, the genesis block, consists of genesis transactions.

:strong:`Binary Format`

See the :ref:`genesis transaction binary format <02_decentralchain:Genesis Transaction Binary Format>`.
...
2. Sender's balance check.
  ...
  2. Depending on the type of transaction, the sender should have enough assets for transfer or for payments attached to the :ref:`invoke script transactions <02_decentralchain:Invoke Script Transaction>`. Order senders in the :ref:`exchange transaction <02_decentralchain:Exchange Transaction>` should have enough funds to exchange.

3. The sender's signature verification 

  1. For ordinary accounts (without script).
  2. For account script execution if the sender is a :ref:`smart account <02_decentralchain:dApp and Smart Account>`.
  3. For verifier function execution if the sender is :ref:`dApp <02_decentralchain:dApp and Smart Account>`. 
  4. A similar check is performed for orders in an :ref:`exchange transaction <02_decentralchain:Exchange Transaction>`.

4. For the invoke script transaction:

  1. Calculation of the result of dApp callable function.
  2.  dApp balance check: dApp account should have enough funds for :ref:`dApp script actions <03_ride-language:Script Actions>`.
  3.  Check that the transaction fee is not less than the :ref:`minimum fee <02_decentralchain:Minimum Fee>` based on script actions.

5. Execution of asset scripts if the transaction uses :ref:`smart assets <02_decentralchain:Smart Asset>`, including scripts of assets used in dApp script actions.

When receiving the transaction via the broadcast endpoint, or adding a transaction to a block, or receiving a block over the network, the node performs full validation of the transaction. When receiving an invoke script transaction over the network, the node performs calculations of the callable function (check 4.1) up to the :ref:`threshold for saving unsuccessful transactions <03_ride-language:Limitations>`.
...
A block generation is a creation of a new :ref:`block <02_decentralchain:Block>` on the blockchain.
Blocks are generated by :ref:`generating nodes <02_decentralchain:Generating Node>` according to :ref:`FPoS algorithm <02_decentralchain:Fair Proof of Stake>` and the :ref:`DecentralChain-M5 protocol <02_decentralchain:DecentralChain-M5 Protocol>`.
The block generator signs the block headers only. The block headers contain the merkle root hash of the block transactions. This makes it possible to verify the block headers apart from transactions and to provide evidence of the presence of transactions in the block without the presence of all transactions. See details in the :ref:`transactions root hash <02_decentralchain:Transactions Root Hash>` article.

Base Target
-----------

The base target is the variable in the average block generation time formula that adjusts :ref:`block generation <02_decentralchain:Block Generation>` time to :math:`60` seconds.

Generation Signature
--------------------

Generation signature is the variable in the average block generation time formula. It is used to check whether the current :ref:`generating node <02_decentralchain:Generating Node>` is eligible to generate the next block.
...
The block height is a sequence number of a :ref:`block <02_decentralchain:Block>` in the blockchain.

Block Signature
===============

A block signature is a hash that a :ref:`generating node <02_decentralchain:Generating Node>` acquires when it signs the :ref:`generated block <02_decentralchain:Block Generation>` with the private key of the account from the node's wallet.

Block Timestamp
===============

A block timestamp is a time of :ref:`block generation <02_decentralchain:Block Generation>`. The time is specified in milliseconds that have passed since the beginning of the unix epoch.

When the :ref:`node <02_decentralchain:Node>` receives a new block from the blockchain network, it verifies that the timestamp value of the block does not outpace the UTC time by more than :math:`100` milliseconds.
The timestamp value of the block is validated by nodes using the formula from FPoS.

Genesis Block
=============

A genesis block is the first :ref:`block <02_decentralchain:Block>` of the blockchain. A genesis block contains one or more :ref:`genesis transactions <02_decentralchain:Genesis Transaction>`. There is one genesis block in the blockchain.
...
The methods are described in the :ref:`transaction <02_decentralchain:Transaction>` article. You can check a transaction on the same blockchain without using a root hash, since the DecentralChain nodes store the entire blockchain data, including all transactions. Use the following built-in Ride function:

.. code-block:: none

  transactionHeightById(id: ByteVector): Int|Unit

The function returns the block height if the transaction with the specified ID exists. Otherwise, it returns a unit. See the function description in the :ref:`blockchain functions <03_ride-language:Blockchain Functions>` article. To check a transaction in a block on the external blockchain you can use the following built-in Ride function:
...
* :ref:`Block <02_decentralchain:Block>` storage.
* :ref:`Transaction validation <02_decentralchain:Transaction Validation>`.
* Sending :ref:`transactions <02_decentralchain:Transaction>`.

Generating Node
===============

Generating node is a node that generates blocks. Each generating node is a :ref:`validating node <02_decentralchain:Validating Node>`. Generating account is an :ref:`account <02_decentralchain:Account>` that a node uses for :ref:`signing <02_decentralchain:Block Signature>` generated blocks. A node can generate blocks if the following conditions are met:

* The node's generating balance is at least :math:`10000` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`. This means that the account balance in DecentralCoins, taking into account leasing, was not less than :math:`10000` DecentralCoins in each of the last :math:`1000` blocks (more details in the :ref:`account balance <02_decentralchain:Account Balance>` article). The greater the generating balance, the higher is your chance of being eligible to generate the next block.
* Node's account is not a :ref:`smart account or dApp <02_decentralchain:dApp and Smart Account>`.
...
A validating node is a node that :ref:`validates <02_decentralchain:Transaction Validation>` transactions.
...
1. Block reward: The current reward size is :math:`6` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>` but it can be changed by voting, see the :ref:`block reward <02_decentralchain:Block Reward>` article.
...
If the :ref:`transaction fees <02_decentralchain:Transaction Fees>` are specified in a sponsored asset, then the block generators receive the fee equivalent in DecentralCoins instead of the fee (as a general rule, in a :math:`\frac{40}{60}` ratio):

.. code-block:: none

  feeInDecentralCoins = feeInSponsoredAsset × 0.001 / minSponsoredAssetFee

minSponsoredAssetFee is the amount of the sponsored asset equivalent to :math:`0.001` DecentralCoins. The sponsor sets this value when enabling sponsorship. For details, see the :ref:`sponsored fees <02_decentralchain:Sponsored Fees>` article.

Block Reward
============

Block reward is a blockchain feature under which :ref:`generating nodes <02_decentralchain:Generating Node>` receive a fixed fee in :ref:`DecentralCoins <02_decentralchain:DecentralCoin>` for each :ref:`generated block <02_decentralchain:Block Generation>`.
...
In the example above, the value of the JSON's currentReward field is 600,000,000 Decentralites— i.e. it's 6 :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`.
...
The block reward is increased/decreased only if more than half of the :math:`10,000` votes — i.e. :math:`5,001` votes or more — were given for increase/decrease. The amount of the current reward is increased/decreased by :math:`0.5` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`.
...
:ref:`Nodes <02_decentralchain:Node>` can use the leased tokens to generate blocks and get the :ref:`mining reward <02_decentralchain:Block Reward>`. For that purpose, the generating balance of a node must be at least :math:`10000` :ref:`DecentralCoins <02_decentralchain:DecentralCoin>`.
...
* These rewards mostly are in :ref:`DecentralCoins <02_decentralchain:DecentralCoin>` but also they can be in the form of different tokens with the unique DecentralCoins feature where different tokens can be accepted as a fee.

LPoS Transactions
-----------------

To start leasing, the token holder needs to create a lease transaction and specify the recipient address (node address) along with the amount of :ref:`DecentralCoins <02_decentralchain:DecentralCoin>` to lease. There are two types of transactions which are used in the LPoS:

* :ref:`Lease transaction <02_decentralchain:Lease Transaction>` to activate the leasing process.
* :ref:`Lease cancel transaction <02_decentralchain:Lease Cancel Transaction>` to deactivate the leasing process.
...
Order is the instruction from the :ref:`account <02_decentralchain:Account>` to matcher to buy or sell a :ref:`token <02_decentralchain:Token (Asset)>` on the exchange. 
...
See the :ref:`order binary format <02_decentralchain:Order Binary Format>` page.
...
* :ref:`Address binary format <02_decentralchain:Address Binary Format>`
* :ref:`Alias binary format <02_decentralchain:Alias Binary Format>`
* :ref:`Block binary format <02_decentralchain:Block Binary Format>`
* :ref:`Network message binary format <02_decentralchain:Network Message Binary Format>`

  * :ref:`Block message binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Checkpoint message binary format <02_decentralchain:Checkpoint Message Binary Format>`
  * :ref:`Get block message binary format <02_decentralchain:Get Block Message Binary Format>`
  * :ref:`Get peers message binary format <02_decentralchain:Get Peers Message Binary Format>`
  * :ref:`Get signatures message binary format <02_decentralchain:Get Signatures Message Binary Format>`
  * :ref:`Handshake message binary format <02_decentralchain:Handshake Message Binary Format>`
  * :ref:`Peers message binary format <02_decentralchain:Peers Message Binary Format>`
  * :ref:`Score message binary format <02_decentralchain:Score Message Binary Format>`
  * :ref:`Signatures message binary format <02_decentralchain:Signatures Message Binary Format>`
  * :ref:`Transaction message binary format <02_decentralchain:Transaction Message Binary Format>`

* :ref:`Order binary format <02_decentralchain:Order Binary Format>`
* :ref:`Transaction binary format <02_decentralchain:Transaction Binary Format>`

  * :ref:`Burn transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Create alias transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Data transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Exchange transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Genesis transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Invoke script transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Issue transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Lease cancel transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Lease transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Mass transfer transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Reissue transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Set asset script transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Set script transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Sponsor fee transaction binary format <02_decentralchain:Block Message Binary Format>`
  * :ref:`Transfer transaction binary format <02_decentralchain:Block Message Binary Format>`

* :ref:`Transaction proofs binary format <02_decentralchain:Transaction Proofs Binary Format>`

Address Binary Format
=====================

Learn more about :ref:`address <02_decentralchain:Address>`.
...
Learn more about :ref:`alias <02_decentralchain:Alias>`.
...
Learn more about :ref:`block <02_decentralchain:Block>`.
...
Learn more about :ref:`order <02_decentralchain:Order>`.
...
Learn more about :ref:`transaction <02_decentralchain:Transaction>`.
...
The guideline for generating a signature and ID is given in the :ref:`cryptographic practical details <02_decentralchain:Cryptographic Practical Details>` article. All strings are UTF-8 encoded.
...
* Fill in the transaction fields.
   ...
   * Addresses should be specified in the shortened binary format (without the first two and the last four bytes). See the :ref:`address binary format <02_decentralchain:Address Binary Format>`) article.
...
* :ref:`Burn transaction binary format <02_decentralchain:Burn Transaction Binary Format>`
* :ref:`Create alias transaction binary format <02_decentralchain:Create Alias Transaction Binary Format>`
* :ref:`Data transaction binary format <02_decentralchain:Data Transaction Binary Format>`
* :ref:`Exchange transaction binary format <02_decentralchain:Exchange Transaction Binary Format>`
* :ref:`Genesis transaction binary format <02_decentralchain:Genesis Transaction Binary Format>`
* :ref:`Invoke script transaction binary format <02_decentralchain:Invoke Script Transaction Binary Format>`
* :ref:`Issue transaction binary format <02_decentralchain:Issue Transaction Binary Format>`
* :ref:`Lease cancel transaction binary format <02_decentralchain:Lease Cancel Transaction Binary Format>`
* :ref:`Lease transaction binary format <02_decentralchain:Lease Transaction Binary Format>`
* :ref:`Mass transfer transaction binary format <02_decentralchain:Mass Transfer Transaction Binary Format>`
* :ref:`Reissue transaction binary format <02_decentralchain:Reissue Transaction Binary Format>`
* :ref:`Set asset script transaction binary format <02_decentralchain:Set Asset Script Transaction Binary Format>`
* :ref:`Set script transaction binary format <02_decentralchain:Set Script Transaction Binary Format>`
* :ref:`Sponsor fee transaction binary format <02_decentralchain:Sponsor Fee Transaction Binary Format>`
* :ref:`Transfer transaction binary format <02_decentralchain:Transfer Transaction Binary Format>`
* :ref:`Update asset info transaction binary format <02_decentralchain:Update Asset Info Transaction Binary Format>`

Burn Transaction Binary Format
------------------------------

Learn more about :ref:`burn transaction <02_decentralchain:Burn Transaction>`.
...
Learn more about :ref:`create alias transaction <02_decentralchain:Create Alias Transaction>`.
...
Learn more about :ref:`data transaction <02_decentralchain:Data Transaction>`.
...
Learn more about :ref:`exchange transaction <02_decentralchain:Exchange Transaction>`.
...
Learn more about :ref:`genesis transaction <02_decentralchain:Genesis Transaction>`.
...
Learn more about :ref:`invoke script transaction <02_decentralchain:Invoke Script Transaction>`.
...
Learn more about :ref:`issue transaction <02_decentralchain:Issue Transaction>`.
...
Learn more about :ref:`lease cancel transaction <02_decentralchain:Lease Cancel Transaction>`
...
Learn more about :ref:`lease transaction <02_decentralchain:Lease Transaction>`.
...
Learn more about :ref:`mass transfer transaction <02_decentralchain:Mass Transfer Transaction>`.
...
Learn more about :ref:`reissue transaction <02_decentralchain:Reissue Transaction>`.
...
Learn more about :ref:`set asset script transaction <02_decentralchain:Set Asset Script Transaction>`.
...
Learn more about :ref:`set script transaction <02_decentralchain:Set Script Transaction>`.
...
Learn more about :ref:`sponsor fee transaction <02_decentralchain:Sponsor Fee Transaction>`.
...
Learn more about :ref:`transfer transaction <02_decentralchain:Transfer Transaction>`.
...
Learn more about :ref:`update asset info transaction <02_decentralchain:Update Asset Info Transaction>`.
